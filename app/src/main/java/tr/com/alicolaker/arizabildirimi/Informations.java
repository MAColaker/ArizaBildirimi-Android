...
import com.alicolaker.arizabildirimi.R;
...
public class Informations extends AppCompatActivity {
    ...
    private ProgresssBar progresssBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progresssBar =new ProgresssBar(Informations.this);

        progresssBar.dialogShow("Bilgiler Alınıyor...");
        ...
        protected void onPostExecute(Object o) {
            ...
            try {
                ...
                if(!username.equals("")){//Eger boş değil ise
                    //Giriş yapılıyor
                    new EnterPanel(getApplicationContext(),username,password, progresssBar );
                }else{//Boş ise
